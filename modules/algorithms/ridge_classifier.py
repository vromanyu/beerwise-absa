...
MODELS_DIRECTORY = "./models/ridge_classifier"
...
def ridge_classifier_trainer() -> None:
    ...
    base_model = RidgeClassifier(class_weight="balanced", random_state=42, solver="sag")
    ...
    model_path = f"{MODELS_DIRECTORY}/multioutput_ridge_classifier_model.pkl"
    joblib.dump(model, model_path)
    vectorizer_path = f"{MODELS_DIRECTORY}/ridge_classifier_vectorizer.pkl"
