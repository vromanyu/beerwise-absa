...
MODELS_DIRECTORY = "./models/naive_bayes"
...
def naive_bayes_trainer() -> None:
    ...
    model_path = f"{MODELS_DIRECTORY}/multioutput_naive_bayes_model.pkl"
    joblib.dump(model, model_path)
    vectorizer_path = f"{MODELS_DIRECTORY}/naive_bayes_vectorizer.pkl"
